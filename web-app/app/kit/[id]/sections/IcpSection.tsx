  ...
  return (
    <section className="border-t border-rule pt-12 mt-12">
      ...
      <p className="text-sm text-muted-strong mb-6 max-w-[60ch]">
        Behaviors a fit customer shows in the first ten minutes of a discovery
        call. Not job titles. Not company size.
      </p>

      <div className="border border-rule-strong bg-paper-pure p-6 sm:p-8 mb-6">
